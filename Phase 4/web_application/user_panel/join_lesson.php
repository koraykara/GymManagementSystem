                ...
                if($result = mysqli_query($conn, $sql)){
                    if(mysqli_num_rows($result) > 0){
                        ...
                        for( $i=0;$i<count ($merge_same_lesson); $i++){
                            ...
                            echo "<td>";
                            echo  "<a href='includes/buy_lesson.inc.php?LessonName=". $merge_same_lesson[$i][0][0]."&Room=" .$merge_same_lesson[$i][5][0] ."'
                        title='Select Lesson' data-toggle='tooltip'><span class='glyphicon glyphicon-plus'></span></>";
